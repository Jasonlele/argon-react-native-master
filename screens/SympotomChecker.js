...
class SympotomChecker extends React.Component {
  ...
  updateSearch = (search) => {
    ...
    this.setState({
      firstSearchPageData: this.state.firstPageData.filter(
  ...
  secondClickButton = (item) => {
    ...
    for (let index = 0; index < judge.length; index++) {
      ...
      if (
        element.includes(this.state.firsrPageSelected) &&
    ...
    return (
      <Block flex style={styles.container}>
        ...
        <Block style={styles.card}>
          ...
          {/* (2020b). GitHub - 24ark/react-native-step-indicator: A simple react-native implementation of step indicator widget compatible with the ViewPager and ListView. GitHub. https://github.com/24ark/react-native-step-indicator */}
            <StepIndicator
              stepCount={3}
          ...
          >
                  ...
                  {this.state.firstSearchPageData.map((item) => {
                    return (
                      <Button
                        ...
                        color={
                          item == this.state.firsrPageSelected
                            ? "success"
                            : "warning"
                        }
            ...
            <View
              key={"page3"}
              style={{ backgroundColor: "#D9E6F7", height: 600 }}
            >
              {this.state.result.length > 0 ? (
                ...
                <Button size="large" color="success" onPress={() => {}}>
