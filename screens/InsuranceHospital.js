...
class InsuranceHospital extends React.Component {
  constructor(props) {
    super(props);
  }
        ...
        <Block flex>
            <Block flex middle>
                ...
                <Block style={styles.clinicCard}>
                    ...
                    <ScrollView>
                        <Text style={{fontSize:28}}>Hospital services in Australia are provided by both the public and private sectors. Public hospitals are owned and managed by state and territory governments.
...
export default InsuranceHospital;
